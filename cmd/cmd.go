...
const cmdLong = `goddess (嫦娥) is the service governance platform for the goddess platform, providing unified service governance capabilities.
...
func NewCmd() *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "goddess",
		Short: "goddess service governance platform - goddess service",
		Long:  cmdLong,
