...
const cmdLong = `Display version information and build details for the Goddess service.

The version command displays detailed information about the current Goddess service,
...
Use Cases:
  • Version verification: Confirm the version of the currently running Goddess service
...
func NewCmd() *cobra.Command {
	versionCmd := &cobra.Command{
		Use:   "version",
		Short: "Display version information and build details for the Goddess service",
		Long:  cmdLong,
