...
const OperationUserUpdateUserStatus = "/goddess.api.v1.User/UpdateUserStatus"
...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	r := s.Route("/")
	r.PUT("/v1/user/{uid}/status", _User_UpdateUserStatus0_HTTP_Handler(srv))
