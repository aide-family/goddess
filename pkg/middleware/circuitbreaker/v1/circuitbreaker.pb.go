...
import (
	v1 "github.com/aide-family/goddess/pkg/config/v1"
...
var file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x24, 0x67, 0x6f, 0x64, 0x64, 0x65, 0x73, 0x73, 0x2e, 0x6d, 0x69, 0x64,
	0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x63, 0x69, 0x72, 0x63, 0x75, 0x69, 0x74, 0x62,
	0x72, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x1a, 0x1e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x64, 0x75, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x17, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	...
	0x32, 0x2e, 0x67, 0x6f, 0x64, 0x64, 0x65, 0x73, 0x73, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x67, 0x6f,
	0x64, 0x64, 0x65, 0x73, 0x73, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x6f,
	...
	0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x67, 0x6f, 0x64, 0x64, 0x65, 0x73, 0x73, 0x2e, 0x6d, 0x69,
	...
	0x32, 0x1b, 0x2e, 0x67, 0x6f, 0x64, 0x64, 0x65, 0x73, 0x73, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	...
	0x06, 0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x42, 0x41, 0x5a, 0x3f, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x69, 0x64, 0x65, 0x2d, 0x66, 0x61, 0x6d, 0x69, 0x6c,
	0x79, 0x2f, 0x67, 0x6f, 0x64, 0x64, 0x65, 0x73, 0x73, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x6d, 0x69,
	0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2f, 0x63, 0x69, 0x72, 0x63, 0x75, 0x69, 0x74,
	0x62, 0x72, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_middleware_circuitbreaker_v1_circuitbreaker_proto_goTypes = []any{
	(*CircuitBreaker)(nil),      // 0: goddess.middleware.circuitbreaker.v1.CircuitBreaker
	(*Header)(nil),              // 1: goddess.middleware.circuitbreaker.v1.Header
	(*ResponseData)(nil),        // 2: goddess.middleware.circuitbreaker.v1.ResponseData
	(*BackupService)(nil),       // 3: goddess.middleware.circuitbreaker.v1.BackupService
	(*SuccessRatio)(nil),        // 4: goddess.middleware.circuitbreaker.v1.SuccessRatio
	(*v1.Condition)(nil),        // 5: goddess.config.v1.Condition
	(*v1.Endpoint)(nil),         // 6: goddess.config.v1.Endpoint
	(*durationpb.Duration)(nil), // 7: google.protobuf.Duration
}
var file_middleware_circuitbreaker_v1_circuitbreaker_proto_depIdxs = []int32{
	4, // 0: goddess.middleware.circuitbreaker.v1.CircuitBreaker.success_ratio:type_name -> goddess.middleware.circuitbreaker.v1.SuccessRatio
	2, // 1: goddess.middleware.circuitbreaker.v1.CircuitBreaker.response_data:type_name -> goddess.middleware.circuitbreaker.v1.ResponseData
	3, // 2: goddess.middleware.circuitbreaker.v1.CircuitBreaker.backup_service:type_name -> goddess.middleware.circuitbreaker.v1.BackupService
	5, // 3: goddess.middleware.circuitbreaker.v1.CircuitBreaker.assert_condtions:type_name -> goddess.config.v1.Condition
	1, // 4: goddess.middleware.circuitbreaker.v1.ResponseData.header:type_name -> goddess.middleware.circuitbreaker.v1.Header
	6, // 5: goddess.middleware.circuitbreaker.v1.BackupService.endpoint:type_name -> goddess.config.v1.Endpoint
	7, // 6: goddess.middleware.circuitbreaker.v1.SuccessRatio.window:type_name -> google.protobuf.Duration
